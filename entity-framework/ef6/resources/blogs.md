...
- [.NET 博客-标记： 实体框架](https://blogs.msdn.microsoft.com/dotnet/tag/entity-framework/)
- [ADO.NET （不再使用中） 的博客](https://blogs.msdn.microsoft.com/adonet/)
- [（不再使用中） 的 EF 设计博客](https://blogs.msdn.microsoft.com/efdesign/)

## <a name="current-and-former-ef-team-bloggers"></a>当前和以前 EF 团队的博客作者
...
## <a name="ef-community-bloggers"></a>EF 社区博客作者
