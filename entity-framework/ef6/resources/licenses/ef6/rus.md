...
---
# <a name="entity-framework-6-runtime-license-rus"></a>Entity Framework 6 运行时许可证 (RU)
...
-   **一个。  ВТОРИЧНО РАСПРОСТРАНЯЕМЫЙ КОД。** ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ СОДЕРЖИТ КОД、 КОТОРЫЙ РАЗРЕШАЕТСЯ РАСПРОСТРАНЯТЬ В СОСТАВЕ РАЗРАБАТЫВАЕМЫХ ВАМИ ПРОГРАММ ПРИ СОБЛЮДЕНИИ ВАМИ СЛЕДУЮЩИХ УСЛОВИЙ。
    -   **我。    ПРАВО НА ИСПОЛЬЗОВАНИЕ И РАСПРОСТРАНЕНИЕ。ПРОГРАММНЫЙ КОД И ФАЙЛЫ、 ПЕРЕЧИСЛЕННЫЕ НИЖЕ、 ПРЕДСТАВЛЯЮТ СОБОЙ «ВТОРИЧНО РАСПРОСТРАНЯЕМЫЙ КОД»。**
