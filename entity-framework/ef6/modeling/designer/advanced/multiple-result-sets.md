...
## <a name="accessing-multiple-result-sets-with-code"></a><span data-ttu-id="da4e3-112">使用代码访问多个结果集</span><span class="sxs-lookup"><span data-stu-id="da4e3-112">Accessing Multiple Result Sets with Code</span></span>
